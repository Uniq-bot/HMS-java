...
/**
 * Manager Dashboard - Main dashboard for manager users.
 * Provides access to sales reports and issue management.
 */
public class ManagerDashboard extends JFrame {
    ...
    private void initializeUI() {
        setTitle("Hall Booking System - Manager Dashboard");
        ...
        contentPanel.add(new SalesReportFrame(manager, this), "sales");
        contentPanel.add(new IssueManagementFrame(manager, this), "issues");
    ...
    private JPanel createSidebar() {
        ...
        JLabel userName = new JLabel("<html><b>" + manager.getName() + "</b><br><small>Manager</small></html>");
        ...
        JButton salesBtn = createMenuButton("💰 Sales Reports");
        salesBtn.addActionListener(e -> showPanel("sales"));
        menuPanel.add(salesBtn);
        
        JButton issuesBtn = createMenuButton("⚠️ Issue Management");
        issuesBtn.addActionListener(e -> showPanel("issues"));
        menuPanel.add(issuesBtn);
    ...
    private JPanel createDashboardPanel() {
        ...
        // Header
        JLabel headerLabel = UIComponents.createTitleLabel("Manager Dashboard");
        ...
        long openIssues = issueService.getOpenIssues().size();
        long resolvedIssues = issueService.getResolvedIssues().size();
        
        statsPanel.add(createStatCard("Total Revenue", String.format("RM %.2f", totalRevenue), UIComponents.SUCCESS_COLOR, "💰"));
        statsPanel.add(createStatCard("Total Bookings", String.valueOf(totalBookings), UIComponents.PRIMARY_COLOR, "📅"));
        statsPanel.add(createStatCard("Open Issues", String.valueOf(openIssues), UIComponents.DANGER_COLOR, "⚠️"));
        statsPanel.add(createStatCard("Resolved Issues", String.valueOf(resolvedIssues), new Color(142, 68, 173), "✅"));
        ...
        actionsPanel.add(createActionCard("View Sales Reports", "Analyze revenue and booking statistics", "sales"));
        actionsPanel.add(createActionCard("Manage Issues", "Review and respond to customer issues", "issues"));
        actionsPanel.add(createActionCard("Performance Overview", "View system performance metrics", "dashboard"));
